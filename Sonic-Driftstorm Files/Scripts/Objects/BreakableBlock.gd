...
func physics_collision(body, hitVector):
	if breakable or (!breakable and drillDive_only and body.get_collision_layer_value(24)):
	...
	elif !breakable and (breakable and drillDive_only and !body.get_collision_layer_value(24)):
